...
namespace HomeworkSimulator.UI
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            comboSimulationSelection.Items.Add("Homework 9 - Sampling Variance Simulation");
            comboSimulationSelection.Items.Add("Homework 10 - Numerical Integration Simulation"); // Added Homework 10
        }
        ...
        private void btnStartSimulation_Click(object sender, EventArgs e)
        {
            ...
            else if (selectedSimulation == "Homework 10 - Numerical Integration Simulation")
            {
                // Open Homework 10 form
                Homework10Form homework10Form = new Homework10Form();
                homework10Form.Show();
            }
            else
            {
